...
#ifdef SPECTRAL_EXPORTS
#define SPECTRAL_API __declspec(dllexport)
#else
#define SPECTRAL_API __declspec(dllimport)
#endif
...
#define SPECTRAL_LEDNAME_INVALID (Spectral::LedName)0
...
extern "C"
{
	...
	SPECTRAL_API bool SpectralInitialize();

	/// <summary>Checks if the Spectral library is initialized.</summary>
	/// <returns>True if initialized.</returns>
	SPECTRAL_API bool SpectralIsInitialized();
	...
	SPECTRAL_API bool SpectralLogitechIsEnabled();
	...
	*/
	...
	SPECTRAL_API bool SpectralSetColor(UCHAR red, UCHAR green, UCHAR blue);
	...
	SPECTRAL_API bool SpectralSetColorForLed(UCHAR ledName, UCHAR red, UCHAR green, UCHAR blue);

	/// <summary>Sets the color of the specified LEDs on enabled devices to the specified color.</summary>
	/// <param name="count">The number of LED Name values provided.</param>
	...
	SPECTRAL_API bool SpectralSetColorForLeds(int count, UCHAR ledNames[], UCHAR red, UCHAR green, UCHAR blue);
	...
	SPECTRAL_API bool SpectralSetColorForDevice(UCHAR deviceType, UCHAR red, UCHAR green, UCHAR blue);
	...
	SPECTRAL_API void SpectralShutdown();
